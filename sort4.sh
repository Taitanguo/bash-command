...
sort -n -r -t$'\t' -k2
#which means we sorting according numerical and in the reverse order"deceding" -t means seperate in the specific symbal"\t" tab, and -k2 means sort according the second column
